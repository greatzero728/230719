...
if "%2" == "" (
    ...
    if EXIST %problem_name%_%1.class run -t 2 -m 256M java -ea -Xss64M -Xmx256M %problem_name%_%1
    ...
    if EXIST Check.class java -Xmx256M -Xss64M -cp ..\testlib4j.jar;. ru.ifmo.testlib.CheckerFramework Check %problem_name%.in %problem_name%.out %2.a
